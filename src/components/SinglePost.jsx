    ...
    return (
        <article className="container-small margin-top-small">
            ...
            <p className="text-background">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, perspiciatis optio obcaecati animi dolor accusamus, similique aperiam sequi quam fugiat mollitia accusantium. Maiores quae fugiat, dolore provident velit ex beatae.
            </p>
            <h2>Why not me?</h2>
